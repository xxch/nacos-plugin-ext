...
/**
 * The OceanBase implementation of TenantCapacityMapper in Oracle mode for Nacos 3.1.1+.
 *
 * @author OceanBase Plugin Team
 **/
public class TenantCapacityMapperByOceanbase extends AbstractOceanbaseMapper
	...
	public MapperResult select(MapperContext context) {
		String sql = "SELECT id, quota, usage, max_size, max_aggr_count, max_aggr_size, tenant_id FROM tenant_capacity "
				+ "WHERE tenant_id = NVL(?, '" + DEFAULT_NAMESPACE_ID + "')";
