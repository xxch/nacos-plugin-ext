...
/**
 * The OceanBase implementation of HistoryConfigInfoMapper.
 * @author OceanBase Plugin Team
 */
public class HistoryConfigInfoMapperOceanbase extends AbstractOceanbaseMapper
	...
	public MapperResult pageFindConfigHistoryFetchRows(MapperContext context) {
		...
		String sql =
				"SELECT nid,data_id,group_id,tenant_id,app_name,src_ip,src_user,op_type,ext_info,publish_type,gray_name,gmt_create,gmt_modified FROM his_config_info "
