...
-- Table: config_info_gray (since 2.5.0 / Nacos 3.x)
CREATE TABLE config_info_gray (
     ...
     gmt_create datetime(3) NOT NULL DEFAULT GETDATE(),
     gmt_modified datetime(3) NOT NULL DEFAULT GETDATE(),
     app_name varchar(128) NULL,
     tenant_id varchar(128) DEFAULT '',
     gray_name varchar(128) NOT NULL,
     gray_rule nvarchar(max) NOT NULL,
     encrypted_data_key nvarchar(256) NOT NULL DEFAULT '',
