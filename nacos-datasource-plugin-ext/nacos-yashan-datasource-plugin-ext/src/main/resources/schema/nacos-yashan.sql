...
CREATE TABLE "CONFIG_INFO_GRAY" (
	"ID" BIGINT DEFAULT "CONFIG_INFO_GRAY_ID_SEQ".NEXTVAL NOT NULL,
	"DATA_ID" VARCHAR(255 CHAR) NOT NULL,
	"GROUP_ID" VARCHAR(128 CHAR) NOT NULL,
	"CONTENT" CLOB NOT NULL,
	"MD5" VARCHAR(32 CHAR) DEFAULT NULL,
	"SRC_USER" CLOB,
	"SRC_IP" VARCHAR(100 CHAR) DEFAULT NULL,
	"GMT_CREATE" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"GMT_MODIFIED" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"APP_NAME" VARCHAR(128 CHAR) DEFAULT NULL,
	"TENANT_ID" VARCHAR(128 CHAR) DEFAULT '',
	"GRAY_NAME" VARCHAR(128 CHAR) NOT NULL,
	"GRAY_RULE" CLOB NOT NULL,
	"ENCRYPTED_DATA_KEY" VARCHAR(256 CHAR) DEFAULT '',
	PRIMARY KEY ("ID")
);
...
CREATE TABLE "HIS_CONFIG_INFO" (
	...
	"TENANT_ID" VARCHAR(128 CHAR) DEFAULT '',
	"ENCRYPTED_DATA_KEY" VARCHAR(1024 CHAR) DEFAULT NULL,
	"PUBLISH_TYPE" VARCHAR(50 CHAR) DEFAULT 'formal',
	"GRAY_NAME" VARCHAR(128 CHAR) DEFAULT NULL,
