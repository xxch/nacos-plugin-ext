...
CREATE TABLE "NOCOS"."CONFIG_INFO_GRAY"
(
    "ID"                 BIGINT IDENTITY(1,1) NOT NULL,
    "DATA_ID"            VARCHAR(255) NOT NULL,
    "GROUP_ID"           VARCHAR(128) NOT NULL,
...
ALTER TABLE "NOCOS"."CONFIG_INFO_GRAY"
    ADD CONSTRAINT PRIMARY KEY ("ID");

ALTER TABLE "NOCOS"."CONFIG_INFO_GRAY"
    ADD CONSTRAINT "UK_CONFIGINFOGRAY_DATAGROUPTENANTGRAY" UNIQUE ("DATA_ID", "GROUP_ID", "TENANT_ID", "GRAY_NAME");

CREATE INDEX "IDX_DATAID_GMT_MODIFIED" ON "NOCOS"."CONFIG_INFO_GRAY" ("DATA_ID", "GMT_MODIFIED");
CREATE INDEX "IDX_GMT_MODIFIED" ON "NOCOS"."CONFIG_INFO_GRAY" ("GMT_MODIFIED");
...
COMMENT
ON TABLE "NOCOS"."CONFIG_INFO_GRAY" IS 'config_info_gray';

COMMENT
ON COLUMN "NOCOS"."CONFIG_INFO_GRAY"."ID" IS 'id';

COMMENT
ON COLUMN "NOCOS"."CONFIG_INFO_GRAY"."DATA_ID" IS 'data_id';

COMMENT
ON COLUMN "NOCOS"."CONFIG_INFO_GRAY"."GROUP_ID" IS 'group_id';

COMMENT
ON COLUMN "NOCOS"."CONFIG_INFO_GRAY"."GRAY_NAME" IS 'gray_name';

COMMENT
ON COLUMN "NOCOS"."CONFIG_INFO_GRAY"."GRAY_RULE" IS 'gray_rule';
